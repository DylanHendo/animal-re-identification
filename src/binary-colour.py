...
siamese_network.compile(loss='binary_crossentropy', optimizer=keras.optimizers.Adam(learning_rate=0.00001), metrics=['accuracy'])
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(f"../results/{DATA}_binary_loss_colour.png", bbox_inches='tight')
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(f"../results/{DATA}_binary_acc_colour.png", bbox_inches='tight')
